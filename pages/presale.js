                    ...
                    >
                      ...
                      <div className="grid grid-cols-2 md:mt-10 sm:mt-5">
                        <div className="button-area mb-4">
                          <div className="btn rounded text-uppercase md:text-lg sm:text-base font-bold">
                            Buy With Eth
                          </div>
                        </div>
                        <div className="button-area mb-4">
            ...
            <div className="grid xl:grid-cols-4 lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 lg:gap-10 md:gap-8 sm:gap-5 sm:p-5">
              <div className="panel mb-10">
                ...
                <div className=" text-left text-capitalize md:text-lg md:font-bold sm:text-md sm:font-semibold">
                  ...
                  desktop and mobile devices. If you don't have a wallet yet,
                  you can download one of these wallets from their official
                  websites.
                </div>
              </div>
              <div className="panel mb-10">
                ...
                <div className="text-left text-capitalize md:text-lg md:font-bold sm:text-md sm:font-semibold">
                  With your wallet connected, you can now purchase Codo tokens
                  on our website. You'll need to have Ethereum (ETH) in your
                  wallet to complete the transaction. You can specify the amount
                  of ETH you'd like to purchase, and the website will
                  automatically calculate the equivalent amount in CODO tokens.
                  Please make sure to double check the details of the
              ...
              <div className="panel mb-10">
                ...
                <p className="text-left text-capitalize md:text-lg md:font-bold sm:text-md sm:font-semibold">
                  ...
                  your token balance in the sales panel. However, the tokens
                  will not be available for transfer or use until the end of the
                  token sale. Keep an eye on our social channels for updates on
                  the sale progress and for instructions on claiming your tokens
                  once the sale has ended. Additionally, you can track sales
            ...
            <div className="grid lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1">
              ...
              <div className="flex flex-col justify-center md:gap-4 sm:gap-2 md:p-10 sm:px-10 p-5">
                <div className="flex justify-between pb-3 px-3">
                  <div className="title-20">Presale</div> &nbsp;
                  <div className="title-20 item-percent presale">% 50</div>
                </div>
                <div className="flex justify-between pb-3 px-3">
                  <div className="title-20">Foundation & Development</div>{" "}
                  &nbsp;
                  <div className="title-20 item-percent fd">% 10</div>
                </div>
                <div className="flex justify-between pb-3 px-3">
                  <div className="title-20">Airdrop & Bounty</div> &nbsp;
                  <div className="title-20 item-percent airdrop">% 10</div>
                </div>
                <div className="flex justify-between pb-3 px-3">
                  <div className="title-20">Liquidity</div> &nbsp;
                  <div className="title-20 item-percent liquidity">% 05</div>
                </div>
                <div className="flex justify-between pb-3 px-3">
                  <div className="title-20">Cex & Dex pool</div> &nbsp;
                  <div className="title-20 item-percent dex">% 20</div>
                </div>
                <div className="flex justify-between pb-3 px-3">
                  <div className="title-20">TeamAllocation</div> &nbsp;
                  <div className="title-20 item-percent team">% 05</div>
                </div>
              </div>
            </div>
          </div>
                      ...
                      <div className="content-address">
                        <div className="flex flex-row justify-between">
                          ...
                          <div className=" pl-3 border-l-2 border-black">
                            <img src="/assets/images/copy.png" alt="copy" width={22}/>
                          </div>
                        </div>
                      </div>
                  </div>
