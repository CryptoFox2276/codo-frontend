        ...
        return <>
            {
              <div>
                  <div className="center pb-3">
                    <p className="font-bold text-black text-uppercase" style={{fontFamily: 'Lexend'}}>buy in before price increases</p>
                  </div>
              ...
              <div className="">
                <div className="panel lg:w-3/4 w-full relative">
                  <div className="flex justify-center gap-10 panel-header">
                    <h2 className="md:text-3xl text-2xl font-bold" style={{fontFamily: 'Lexend'}}>$126,000</h2>
                  </div>
                  <div className="m-auto">
                    <PresaleCountDown />
                  </div>
                  <div className="switch-network">
                    <div className={`network-item ${selected=='ETH' && 'selected'}`} onClick={()=>setSelected('ETH')}><img src="/assets/images/icons/eth-icon.png" className="pr-2"/>ETH</div>
                    <div className={`network-item ${selected=='BSC' && 'selected'}`} onClick={()=>setSelected('BSC')}><img src="/assets/images/icons/bsc-icon.png"  className="pr-2"/>BSC</div>
                  </div>
                  ...
                  <div className="sub-panel">
                    ...
                    <div className="progressbar">
                      <ProgressBar bgcolor="#F5A11E" completed={totalSoldPercent} label={false}/>
                    </div>
                  </div>
