        ...
        <section id="digital-assets">
            <div className="container m-auto">
                <div className="container-header">
                    <div className="title">
                        Shapping the Frontier of Digital Assets
                    </div>
                </div>
                <div className="container-body">
                    <div className="dot-group">
                    </div>
                    <div className="assets-group w-full">
                        <div className="assets-body w-full flex flex-row m-auto align-middle items-center">
